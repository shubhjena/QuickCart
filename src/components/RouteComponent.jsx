  ...
  return (
    <div>
      <Routes>
        ...
        <Route path='/product' element={<Product product={product} setProduct={setProduct} view={view} addToCart={addToCart} addToWishlist={addToWishlist}/>}/>
        <Route path='/dp' element={<ViewProduct show={show} addToCart={addToCart}/>}/>
